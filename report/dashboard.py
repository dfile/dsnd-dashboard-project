...
class LineChart(MatplotlibViz):
    ...
    def visualization(self, entity_id, model):
        ...
        events = model.event_counts(entity_id)
        ...
        events = events.set_index("event_date")
        ...
        events_cum = events.cumsum()
        
        
        # Set the dataframe columns to the list
        # ['Positive', 'Negative']
        events_cum.columns = ["Positive", "Negative"]
...
@app.get("/employee/{templated_variable}")
def get(templated_variable: str):
    # Call the initialized report
    # pass the ID and an instance
    # of the Employee SQL class as arguments
    # Return the result
    return report(templated_variable, Employee())
...
# to a string datatype
@app.get("/team/{templated_variable}")
def get(templated_variable: str):
    # Call the initialized report
    # pass the id and an instance
    # of the Team SQL class as arguments
    # Return the result
    return report(templated_variable, Team())
